  ...
  <div class="switch-body">
    <div class="cases-list">
      <div v-for="port in caseOutputs" :key="port.id" class="case-row">
        <input class="case-input" :value="port.name"
    ...
    <button class="add-btn" @click.stop="emit('add-case')" @pointerdown.stop>+ add case</button>
  </div>
</template>
...
.case-input { flex: 1; padding: 1px 4px; border-radius: 3px; border: 1px solid #45475a; background: #11111b; color: #cdd6f4; font-size: 10px; font-family: monospace; outline: none; min-width: 0; }
.case-input:focus { border-color: #89b4fa; }
.rm { width: 14px; height: 14px; border-radius: 3px; border: 1px solid #45475a; background: transparent; color: #6c7086; font-size: 11px; cursor: pointer; display: flex; align-items: center; justify-content: center; padding: 0; flex-shrink: 0; }
